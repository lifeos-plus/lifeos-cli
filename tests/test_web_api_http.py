...
def test_area_order_database_locked_retries_then_503(
    ...
    assert attempts["count"] == routers.areas.ORDER_WRITE_RETRY_ATTEMPTS
...
def test_area_order_database_locked_by_raw_connection_returns_503(
    ...
    monkeypatch.setattr(routers.areas, "ORDER_WRITE_RETRY_ATTEMPTS", 1)
    monkeypatch.setattr(routers.areas, "ORDER_WRITE_RETRY_BACKOFF_SECONDS", (0.0,))
